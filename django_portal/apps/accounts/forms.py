...
from .models import ClientProfile, User, UserDocument
...
class CustomUserCreationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Username field is not in Meta.fields, so only modify if it exists
        ...
        if phone:
            try:
                ...
                raise ValidationError(
                    _("Enter a valid phone number (e.g., +254712345678).")
                )
        return phone
...
class ClientProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "employer_address": forms.Textarea(
    ...
    def clean_mpesa_phone(self):
        ...
        if phone:
            try:
                ...
                raise ValidationError(
                    _("Enter a valid M-Pesa phone number (e.g., +254712345678).")
                )
        return phone
